...
//http://localhost:5000/users?userId=618ded610e54a12c54335d95 or
//http://localhost:5000/users?username=mai
router.get("/", async (req, res) => {
  ...
  try {
    ...
    //to skip sensitive infomation like password from get request
...
router.get("/friends/:userId", async (req, res) => {
  try {
    ...
    //get all friends that user followings
